                ...
                <div style="box-sizing: border-box;">
                  <el-form :inline="true" :model="formInline" class="demo-form-inline"
                    ...
                    <el-form-item label="客户名称：">
                      <el-input v-model="formInline.customerName" placeholder="输入客户名称关键字"
                                size="small"></el-input>
                    </el-form-item>
          ...
          <div class="el-table-diy box-content" style="margin-top:0 ">
            ...
            <el-row>
              <el-table
                ...
                >
                  <template slot-scope="scope">
                    <span class="text-grey" v-if="scope.row.type===1">销售单</span>
                ...
                >
                  <template slot-scope="scope">
                    <span class="text-grey"> {{ scope.row.customername }}</span>
                  </template>
                </el-table-column>
  ...
  export default {
    ...
    methods: {
      getData() { // 获取列表数据
        ...
        http.axiosGet(api.salesOrder.getOrderListByPage, params,
          response => {
            self.loading = false
      ...
      formDelete(id) {//删除
        ...
        this.showCancelMessage(
          () => {
            http.axiosPost(api.salesOrder.delete, params,
              response => {
                if (response.data.rc === 200) {
      ...
      getParamsLocalStorage() {//读取缓存查询条件
        ...
        if (pageParam) {
          ...
          if (pageParam.pageName == 'supplierList') {
            ...
            this.formInline.customerName = pageParam.customerName;
